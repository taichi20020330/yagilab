...
#edited
## ここに特徴量全部ぶち込んでいく
df = pd.read_csv("features/list_cut_flt_2023_gutya.csv", skiprows = 0)


df = df[df['group'] == 1]

#tone07-1を抜く
# df = df[df['ID'] != 'tone007_neck1_clipout']
...
df_updrs_list = pd.read_csv("features/updrs_list_2023.csv", skiprows = 0)
